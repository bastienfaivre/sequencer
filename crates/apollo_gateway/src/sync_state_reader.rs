...
impl BlockifierStateReader for SyncStateReader {
    ...
    fn get_nonce_at(&self, contract_address: ContractAddress) -> StateResult<Nonce> {
        let res =
            self.runtime.block_on(self.state_sync_client.get_nonce_at(self.block_number, contract_address));
    ...
    fn get_compiled_class(&self, class_hash: ClassHash) -> StateResult<RunnableCompiledClass> {
        let contract_class = self.runtime.block_on(self.class_manager_client.get_executable(class_hash))
            .map_err(|e| StateError::StateReadError(e.to_string()))?
            .expect(
        ...
        match contract_class {
            ContractClass::V1(casm_contract_class) => {
                let is_class_declared = self.runtime.block_on(
    ...
    fn get_class_hash_at(&self, contract_address: ContractAddress) -> StateResult<ClassHash> {
        let res =
            self.runtime.block_on(self.state_sync_client.get_class_hash_at(self.block_number, contract_address));
...
impl StateReaderFactory for SyncStateReaderFactory {
    fn get_state_reader_from_latest_block(
        ...
        let latest_block_number =
            self.runtime.block_on(self.shared_state_sync_client.get_latest_block_number())?

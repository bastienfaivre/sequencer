...
use starknet_api::test_utils::{
    ...
    DEFAULT_STRK_L2_GAS_PRICE, MAX_FEE, NonceManager, TEST_SEQUENCER_ADDRESS,
};
...
use crate::test_utils::{
    BALANCE, SaltManager, get_syscall_resources, get_tx_resources, test_erc20_sequencer_balance_key,
};
